module.exports = function(app){
    ...
    app.route('/challenges/:challengeId/chat').post(jwtMiddleware, s3.upload('/chatting').single('img'), chat.makeChatting);
    app.route('/chats/:chattingId').get(jwtMiddleware, chat.eachChatting);
    app.route('/chats/:chattingId').post(jwtMiddleware, s3.upload('/chatting').single('img'), chat.makeComment);
